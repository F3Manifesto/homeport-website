  ...
  return (
    <div className="z-50 bg-blur relative w-full h-full flex">
      <div className="relative w-fit h-fit bg-offBlack grid grid-flow-row auto-rows-[auto auto]">
        ...
        <div className="w-fit h-fit row-start-3 relative text-white grid grid-flow-col auto-cols-[auto auto] place-self-center p-2 font-fira border-2 border-offWhite hover:bg-midBlue">
