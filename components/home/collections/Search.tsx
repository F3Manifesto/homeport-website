...
const Search: FunctionComponent<SearchProps> = ({
  ...
  return (
    <div className="flex relative min-h-96 h-[110vh] sm:h-96 w-full min-w-fit">
      <div className="relative w-full h-full grid auto-cols-[auto auto] grid-flow-col">
        <div className="relative col-start-1 w-full h-full row-start-1">
          <div className="relative auto-rows-[auto auto] h-full w-full">
            <div className="relative w-full h-1/2 row-start-1 pt-12 pl-6">
              <div className="relative w-fit h-fit grid auto-rows-[auto auto] grid-flow-row gap-2">
                ...
                <div className="inline-flex relative w-full h-fit row-start-2 w-fit md:whitespace-nowrap">
                  <div className="relative grid auto-col-[auto auto] grid-flow-col h-fit w-fit">
                    {collections.map((collection: any, index: number) => {
                      return (
                        <div
                          className={`m-2 ml-0 border relative border-offBlack rounded-full border-l border-r pl-1 pr-1 cursor-empireS font-conso h-fit w-fit md:col-start-${
                            index + 1
                          } md:row-start-1 col-start-1 row-start-${index + 1}`}
                          key={index}
                        >
                          <button
            ...
            <div className="relative w-full h-1/2 row-start-2 pl-6 col-start-1">
              <div className="w-fit h-fit md:w-20 relative col-start-1 font-conso md:top-auto top-24 sm:pt-0 pt-3">
                FILTER BY NAME
              </div>
              <div className="m-2 ml-0 border border-offBlack rounded-full border-l border-r pl-1 pr-1 h-fit w-fit md:top-auto relative top-24">
                <input
            ...
            <div className="relative w-full h-1/2 row-start-1 lg:row-start-2 lg:pl-0 pl-4 lg:pt-0 pt-12">
              <div className="relative grid auto-rows-[auto auto] grid-flow-row w-fit h-fit">
                ...
                <div className="relative row-start-2 w-full h-fit font-conso row-start-2">
                  <div className="relative auto-cols-[auto auto] w-fit h-fit grid-flow-col grid self-start">
                    {styles.map((style: any, index: number) => {
                      return (
                        <div
                          className={`m-2 ml-0 border border-offBlack rounded-full border-l border-r pl-1 pr-1 cursor-empireS w-fit h-fit relative text-sm xl:text-base xl:col-start-${
                            index + 1
                          } xl:row-start-1 ${
                            index + 1 === 4 &&
                            `row-start-${index + 1} lg:row-start-2`
                          }`}
                          key={index}
                        >
                          <button
