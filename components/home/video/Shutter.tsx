...
const Shutter: FunctionComponent = (): JSX.Element => {
  return (
    <div className="relative grid auto-cols-auto grid-flow-col w-full justify-items-center sm:w-fit min-h-full h-full gap-10 pl-[4vw] pt-0.5 md:pt-[1.5vw] lg:pt-[3.5vw]">
