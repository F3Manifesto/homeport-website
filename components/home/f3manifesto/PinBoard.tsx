...
const PinBoard = (): JSX.Element => {
  return (
    <div className="w-2/12 bg-gradient-to-r from-grad1 via-grad2 to-grad3 h-full absolute right-0 border-2 border-borderBlue col-start-2">
      ...
      <div className="relative w-full h-auto grid grid-cols-3 grid-flow-row top-9">
        <div className="relative h-fit w-fit flex justify-center align-center cursor-empireS hover:rotate-12">
      ...
      <div className="relative w-full max-h-fit grid auto-rows-[auto auto] grid-flow-row gap-6">
