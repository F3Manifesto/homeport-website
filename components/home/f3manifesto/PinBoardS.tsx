...
const PinBoardS = (): JSX.Element => {
  ...
  return (
    <div className="w-full bg-gradient-to-r from-grad1 via-grad2 to-grad3 h-full relative border-2 border-borderBlue overflow-hidden">
      <div className="relative grid auto-rows-auto grid-flow-row w-full h-full gap-10">
        ...
        <div className="relative h-fit w-full row-start-2">
          <div className="relative w-full max-h-fit grid auto-rows-auto grid-flow-row gap-8 justify-center pl-3 pr-3">
