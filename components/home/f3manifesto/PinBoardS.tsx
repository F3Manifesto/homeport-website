...
const PinBoardS = (): JSX.Element => {
  return (
    <div className="w-full bg-gradient-to-r from-grad1 via-grad2 to-grad3 h-full relative border-2 border-borderBlue overflow-hidden">
      <div className="relative grid auto-rows-[auto auto] grid-flow-row w-full h-full gap-10">
            ...
            <div className="relative h-full w-full flex justify-center align-center cursor-empireS hover:rotate-12">
              <Link href="https://digitalax.xyz">
                <a target="_blank" rel="noreferrer" className="cursor-empireS">
                  <Image width={60} height={60} src="/images/digi.png" placeholder="blur" blurDataURL="base64"/>
                </a>
              </Link>
            </div>
            <div className="relative h-full w-full flex justify-center align-center cursor-empireS hover:rotate-12">
              <Link href="https://inarisynth.xyz">
                <a target="_blank" rel="noreferrer" className="cursor-empireS">
                  <Image width={60} height={60} src="/images/inari.png" placeholder="blur" blurDataURL="base64"/>
                </a>
              </Link>
            </div>
            <div className="relative h-full w-full flex justify-center align-center cursor-empireS hover:rotate-12">
              <Link href="https://diysynth.xyz">
                <a target="_blank" rel="noreferrer" className="cursor-empireS">
                  <Image width={60} height={60} src="/images/diy.png" placeholder="blur" blurDataURL="base64"/>
                </a>
              </Link>
            </div>
          </div>
        ...
        <div className="relative h-fit w-full row-start-2">
          <div className="relative w-full max-h-fit grid auto-rows-[auto auto] grid-flow-row gap-8 justify-center pl-3 pr-3">
            <div className="relative w-fit h-fit row-start-1">
              <div className="relative grid auto-cols-[auto auto] grid-flow-col w-full h-fit gap-8">
