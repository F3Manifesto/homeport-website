  ...
  return (
    <div className="relative grid grid-flow-col auto-cols-[auto auto] w-full max-h-screen h-screen min-h-screen justify-center text-black font-animosaR bg-shaded">
      ...
      >
        ...
        />
        <button
          className="relative w-full h-fit bg-lBlue border-2 border-white text-white rounded-md -top-24 py-2 cursor-pointer hover:bg-lBlue active:scale-95 active:bg-lBlue"
          type="submit"
        >
          Log In
        </button>
